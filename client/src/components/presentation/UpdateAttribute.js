...
class UpdateAttribute extends Component {
  ...
  render() {
    ...
    styleEdit = (this.state.isEdited) ? styleEdit + "d-none" : styleEdit + "d-inline"
    let styleSaveEdit = "btn btn-warning "
    styleSaveEdit = (this.state.isEdited) ? styleSaveEdit + "d-inline" : styleSaveEdit + "d-none"
    let styleCancelEdit = "btn btn-danger "
    styleCancelEdit = (this.state.isEdited) ? styleCancelEdit + "d-inline" : styleCancelEdit + "d-none"
    let styleEditForm = "form-group row "
    styleEditForm = (this.state.isEdited) ? styleEditForm + "" : styleEditForm + "d-none"
    return (
      <span>
        <div className={styleEditForm}>
          ...
          <div className="col-sm-10">
            <input onChange={(event) => this.updateAttribute(event, 'name')} className="form-control" 
              type="text" placeholder="Name" value={this.state.attribute.name} />
          </div>
        </div>
        <div className={styleEditForm}>
          ...
          <div className="col-sm-10">
            <input onChange={(event) => this.updateAttribute(event, 'type')} className="form-control" 
              type="text" placeholder="Type" value={this.state.attribute.type} />
          </div>
        </div>
        <div className={styleEditForm}>
          ...
          <div className="col-sm-10">
            <input onChange={(event) => this.updateAttribute(event, 'value')} className="form-control" 
              type="text" placeholder="Value" value={this.state.attribute.value} />
          </div>
        </div>
        <div className={styleEditForm}>
          ...
          <div className="col-sm-10">
            <input onChange={(event) => this.updateAttribute(event, 'parentId')} className="form-control" 
              type="text" placeholder="Parent Id" value={this.state.attribute.parentId} />
            <input onChange={(event) => this.updateAttribute(event, '_id')} className="form-control" 
              type="hidden" value={this.state.attribute._id} />
          </div>
        </div>
